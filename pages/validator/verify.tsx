...
const ValidatorVerifyPage = () => {
    ...
    <pre className="p-4 bg-gray-200 rounded text-sm text-gray-800" style={{whiteSpace: "pre-wrap", wordBreak: "break-all"}}>
        {`solana sign-offchain-message `}{`"`}{authCode ? authCode : ':discord-authorization-code'}{`"`}
