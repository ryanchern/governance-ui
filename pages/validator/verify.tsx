    ...
    return (
        <div className="h-screen p-4 pt-16 bg-gray-100 text-black">
            ...
            <div className="p-4 mx-auto w-full md:w-1/2 lg:w-1/2">
                <p className="text-base text-neutral-700 mt-4">1. Enter public key: </p>
                <input
                    type="text"
                    className="border rounded text-left mb-2 w-full p-2"
                    value={publicKey}
                    onChange={(e) => setPublicKey(e.target.value)}
                    placeholder="(cli command: solana address)"
                />
                ...
                <p className="text-base text-neutral-700 mt-4">3. Enter local path to keypair: </p>
                <input
                    type="text"
                    className="border rounded text-left mb-2 w-full p-2"
                    value={keypair}
                    ...
                    placeholder="/User/..."
                />
                <p className="text-base text-neutral-700 mt-4">4. Sign the payload using the Solana CLI’s sign-offchain-message command and send to the endpoint.</p>
